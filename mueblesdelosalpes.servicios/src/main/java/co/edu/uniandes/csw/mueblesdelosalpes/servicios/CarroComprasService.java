...
public class CarroComprasService {
   ...
   @Path("modificarInventario/")
    public void modificarInventario(List<Mueble> inventario){
        carroEjb.setInventario((ArrayList<Mueble>) inventario);
    }
    @GET
    @Path("totalCarrito/")
    public double totalCarrito(){
        return carroEjb.getPrecioTotalInventario();
    }
    @GET
    @Path("conpraTotalUnidades/")
    public int compraTotalUnidades(){
        return carroEjb.getTotalUnidades();
    }
    @POST
    @Path("compra/")
    public void compra(Usuario usuario){
        carroEjb.comprar(usuario);
    }
    @GET
    @Path("recalcularValor/")
    public void recalculaValorCarro(){
